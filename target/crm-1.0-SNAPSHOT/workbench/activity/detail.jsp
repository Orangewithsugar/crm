...
<script type="text/javascript">
	...
	$(function(){
		...
		// ______________________________________________________________________________________________为【保存】按钮绑定事件，添加备注
		...
		// ______________________________________________________________________________________________为【更新】按钮绑定事件
		$("#updateRemarkBtn").click(function () {

			// 这个id，回调函数要用，所以在外面定义一个。  表示打开的模态窗口对应的那个备注的唯一标识id
			var id = $("#remarkId").val();
			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.success){
						...
						// 修改备注成功，改对应备注div中的信息（备注内容+修改时间+修改人）
		...
		$.ajax({
			...
			success : function (data) {
				...
				if(data.success){
					...
					// 删除备注成功，刷新备注列表
					// showRemarkList();   这种方式是不行的，记录使用的是before方法，页面上每一次删除之后都会保留原有的数据
