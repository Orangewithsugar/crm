...
<script type="text/javascript">
	...
	$(function(){
		...
		// ______________________________________________________________________________________________回车查询可以连接的市场活动
		$("#aname").keydown(function (event) {
			...
			if(event.keyCode == 13){
				...
				$.ajax({
					...
					url : "workbench/clue/getActivityBySearchAndNotById.do",
					data : {
		...
		// _______________________________________________________________________________________【关联】按钮：将选择的市场活动关联到线索中
	...
	// ______________________________________________________________________________________________展现当前线索相关的市场活动列表
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data , function (i , n) {
					...
					html += '<td>'+ n.endDate +'</td>';
					html += '<td>'+ n.owner +'</td>';
					html += '<td><a href="javascript:void(0);" onclick="unbund(\''+n.id+'\')" style="stext-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
					html += '</tr>';
	...
	// ___________________________________________________________________________________________________解除线索和市场活动的连接
	function unbund(id) {
